"""
Django settings for progetto_tw project.
...
SECRET_KEY = 'django-insecure-^(!33fx!@!@h)-r6(rq70%qk-c$dh64fojzq*$4hzm$s+0+5$c'
...
WSGI_APPLICATION = 'progetto_tw.wsgi.application'
ASGI_APPLICATION = 'progetto_tw.asgi.application'
